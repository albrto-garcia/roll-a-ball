...
public class JugadorController : MonoBehaviour
{
    ...
    //Para asginar el tiempo de retraso luego de ganar para que comience el juego de nuevo
    void Start()
    {
        //Capturo esa variable al iniciar el juego
        rb = GetComponent<Rigidbody>();
        //Inicio el contador a 0contador = 0;
    ...
    void setTextoContador()
    {
        ...
        if (contador >= 12)
        {
            ...
            //Empiezo un timer y cuando este termine comienza el juego nuevamente
